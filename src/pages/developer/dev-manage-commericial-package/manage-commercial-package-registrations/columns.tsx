...
export const getCommercialRegistrationColumns = (onRefresh?: () => void): ColumnsType<CommercialPackage> => [
  {
  ...
  },
  {
  ...
  },
    {
      title: "Action",
      key: "action",
      render: (_, record: CommercialPackage) => <ActionMenu record={record} onSuccess={onRefresh} />,
    },
];
